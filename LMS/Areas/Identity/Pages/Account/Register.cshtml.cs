...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
       ...
       string CreateNewUser(string firstName, string lastName, DateTime DOB, string worksIn, string role)
        {
            //TODO: see if this method works for a new uid
            ...
            if (role == "Administrator")
            {
                Administrator admin = new()
                {
                    ...
                    FName = firstName,
                    LName = lastName,
                    Dob = DOB // TODO: see if have to do DatOnly.FromDateTime(DOB)
                };
